  ...
  return (
    <>
      <Link
        href="#filtersSection"
        onClick={(e) =>
          scrollToId("filtersSection", { event: e as unknown as MouseEvent })
        }
      >
        <Button
          className="cta-button text-white px-6 py-2 rounded-full w-full sm:w-auto"
          size="lg"
        >
      ...
      <Link
        ...
        onClick={(e) =>
          scrollToId("featuresSection", { event: e as unknown as MouseEvent })
        }
      >
        <Button
          variant="outline"
